export const about_us = {
	...
	link: "https://assets.wbavengers.com/Resource/background_imgs/header_about.jpg",
};
...
export const home_text = {
	...
	subtext: [
		"我们尽可能地保存那些微弱的声音，那些隐蔽的细节",
		"历史的夜空中，任何一粒星屑，都有它被凝视的意义",
	],
	link: "https://assets.wbavengers.com/Resource/background_imgs/header_index.jpg",
};
...
export const timeline_text = {
	...
	link: "https://assets.wbavengers.com/Resource/background_imgs/featured.png",
};

export const common_voice = {
	title: "「观者评说」",
	text: ["那些是我人生最灰暗时刻的微光", "是我能取暖燃烧着的篝火"],
	subtext: ["观者看法众多，并不等于本站立场", "愿君子合而不同，求同存异"],
	link: "https://assets.wbavengers.com/Resource/background_imgs/header_watchers.jpg",
};
...
export const media_text = {
	...
	link: "https://assets.wbavengers.com/Resource/background_imgs/header_case.jpg",
};

export const casfile_text = {
	title: "「部分卷宗」",
